...
When a directive is used they obtain data from the parent controller so never need their own, this contoller is specified along with it's corresponding template in the state provider.
